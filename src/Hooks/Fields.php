...
class Fields
{
    ...
    public function setDcFormatAttributes($arrDcField, $arrField): array
    {
    ...
    public function catalogManagerInitializeFrontendEditing($strTable, $arrCatalog, &$arrFields, $arrValues): void
    {
    ...
    public function convertExtensions($arrExtensions): string
    {
