...
$GLOBALS['TL_LANG']['MSC']['filePickerRemoveFile'] = 'Auswahl entfernen';
$GLOBALS['TL_LANG']['MSC']['filePickerInputLabel'] = 'auswählen';
...
$GLOBALS["TL_LANG"]["MSC"]["dictFileTooBig"] = "Datei ist zu groß ({{ filesize }}MB). Maximale Dateigröße: {{ maxFilesize }}MB.";
